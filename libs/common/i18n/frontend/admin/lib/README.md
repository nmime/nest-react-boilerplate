# @app/common-i18n-frontend-admin

Path: `libs/common/i18n/frontend/admin/lib`
Nx project: `@app/common-i18n-frontend-admin`
Project type: `library`
Tags: `platform:frontend`, `type:common`, `scope:admin`, `boundary:i18n`, `fsd:layer:shared`, `framework:neutral`

## Purpose

Frontend shared library for the admin scope.
...
```bash
pnpm exec nx run @app/common-i18n-frontend-admin:build
```
