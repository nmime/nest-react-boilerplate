...
import { assertRequestTenantMatchesPrincipal, resolveTenantId } from '@app/backend-feature-auth-shared';
...
export class BetterAuthGuard implements CanActivate {
  ...
  private isPublicRoute(context: ExecutionContext): boolean {
    return (
      this.reflector.getAllAndOverride<boolean>(PublicAuthMetadataKey, [context.getHandler(), context.getClass()]) ??
      false
    );
  }
