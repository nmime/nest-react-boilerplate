...
Node and package-manager versions are intentionally pinned through `.nvmrc`, `packageManager`, `engines`, `devEngines`, and `.npmrc` strictness. Use Node 26.x and pnpm 11.10.0 for local parity with CI.
