...
export const Checkbox = forwardRef<ComponentRef<typeof CheckboxPrimitive.Root>, CheckboxProps>(
  ({ className, children, ...props }, ref) => (
    <CheckboxPrimitive.Root className={cn('xr-checkbox', className)} data-slot="checkbox" ref={ref} {...props}>
      <CheckboxPrimitive.Indicator className="xr-checkbox__indicator" data-slot="checkbox-indicator">
        {children ?? '✓'}
...
export const Switch = forwardRef<ComponentRef<typeof SwitchPrimitive.Root>, SwitchProps>(
  ({ className, ...props }, ref) => (
    <SwitchPrimitive.Root className={cn('xr-switch', className)} data-slot="switch" ref={ref} {...props}>
      <SwitchPrimitive.Thumb className="xr-switch__thumb" data-slot="switch-thumb" />
...
export interface UiSwitchProps extends Omit<ComponentPropsWithoutRef<typeof SwitchPrimitive.Root>, 'children'> {
  description?: ReactNode;
  label: ReactNode;
}

export const UiSwitch = forwardRef<ComponentRef<typeof SwitchPrimitive.Root>, UiSwitchProps>(
