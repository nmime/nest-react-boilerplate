...
export type AuthenticatedPrincipalContract = Schema<AuthComponents, 'AuthenticatedPrincipalDto'>;
export type AuthenticatedUserContract = Schema<AuthComponents, 'AuthenticatedUserViewDto'>;
...
export type SupportedLocalesContract = Schema<AuthComponents, 'SupportedLocalesPayloadDto'>;
...
export type UserProfileViewContract = Schema<UserComponents, 'UserProfileViewDto'>;

export type AdminPrincipalContract = Schema<AdminComponents, 'AuthenticatedPrincipalDto'>;
export type AdminProfileContract = Schema<AdminComponents, 'AdminProfilePayloadDto'>;
export type AdminProfileViewContract = Schema<AdminComponents, 'AdminProfileViewDto'>;
