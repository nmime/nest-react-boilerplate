...
import { UiCard, UiEmptyState, UiSection, UiStatusTag } from '@app/frontend-ui-web';
    ...
    >
      <UiCard className="admin-command-center" title="Tenant console runway">
        <div className="admin-command-center__hero">
          <div>
            ...
            <strong>Roadmap page keeps unavailable tenant actions explicit.</strong>
            <span>
              The route is visible only behind roles permission and presents a clear staged plan instead of a blank
              placeholder.
            </span>
          </div>
      ...
      <UiCard className="admin-route-card" title={t('admin.dashboard.stat.pages.label')}>
        <div className="admin-readiness-grid">
          {['/admin/tenants', '/admin/tenants/:id', '/admin/tenants/:id/users'].map((path) => (
