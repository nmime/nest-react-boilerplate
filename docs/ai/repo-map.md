...
| ----------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Backend APIs, consumers, schedulers | `apps/backend/<scope>/**`                                                              | [Project catalog](../project-catalog.md), [Architecture](../architecture.md), [API contracts](../api-contracts.md), [API conventions](../api-conventions.md), [Deployment](../deployment.md)                                                        |
| Frontend apps                       | `apps/frontend/**`                                                                     | [Project catalog](../project-catalog.md), [Frontend FSD](../frontend-fsd.md), [Frontend state](../frontend-state.md), [Frontend UX/design](../frontend-uiux-pro-max-lazyweb.md), [Frontend deployment topology](../frontend-deployment-topology.md) |
...
| Durable database infrastructure     | `libs/backend/{postgres,mongodb}/main/**`                                              | [Database migrations](../database-migrations.md), [Environment variables](../environment-variables.md)                                                                                                                                              |
| Frontend libraries                  | `libs/frontend/**`                                                                     | [Frontend FSD](../frontend-fsd.md), [Frontend state](../frontend-state.md), [Frontend UX](../frontend-ux.md), [Modern QA](../testing/modern-qa.md)                                                                                                  |
...
| Capability activation | `packages/tooling/src/setup/**`, `apps/backend/**/capabilities{,.bootstrap}.generated.ts`                                | [Setup](../setup/configuration.md), [Presets](../setup/presets-and-technologies.md) |
| Notifications         | `libs/common/notifications`, `libs/backend/feature/notification/**`, `libs/backend/{postgres,mongodb}/main/notification` | [Notifications](../notifications.md)                                                |
...
- Start from [Agent skills](../agent-skills.md) when the request describes a
  repeatable development, planning, design, validation, operations, or documentation workflow.
- For frontend work, route through planning, optional experience design, the
  selected web/native implementation skill, and frontend quality validation.
- For backend work, route through planning, the selected API/process skill,
  changed contract/auth/database/notification boundaries, and backend quality validation.
- Start from the [Documentation index](../README.md) for a topic not represented
  in this compact map; `pnpm run docs:check` enforces that repository documents
  remain reachable from that index.
