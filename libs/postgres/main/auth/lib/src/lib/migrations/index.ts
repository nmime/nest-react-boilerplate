...
import { Migration20260606120000AlignAuthUserLocaleConstraint } from "./Migration20260606120000AlignAuthUserLocaleConstraint";
...
export const authMigrations = [
  ...
  Migration20260606120000AlignAuthUserLocaleConstraint,
] as const;
