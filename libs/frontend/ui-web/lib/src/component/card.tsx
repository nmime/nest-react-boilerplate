...
export const CardHeader = ({
  ...
  <div
    className={cn("xr-card__header grid gap-1.5", className)}
...
export const CardTitle = ({
  ...
  <h3
    className={cn(
      "xr-card__title m-0 text-base font-semibold text-foreground",
      className,
    )}
...
export const CardDescription = ({
  ...
  <p
    className={cn("m-0 text-sm leading-7 text-muted-foreground", className)}
...
export const CardContent = ({
  ...
  <div
    className={cn("xr-card__body leading-7 text-muted-foreground", className)}
...
export const CardFooter = ({
  ...
  <div
    className={cn("xr-card__footer flex items-center gap-3", className)}
