...
This is **this boilerplate's own** release history, generated by
semantic-release and frozen for upstream reference.

It is not maintained per PR and nothing gates it. Release notes for new work
are generated from Conventional Commit subjects and published with the
release — see [CONTRIBUTING.md](CONTRIBUTING.md). A product forked from this
