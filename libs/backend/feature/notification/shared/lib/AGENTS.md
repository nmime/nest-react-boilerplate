# @app/backend-feature-notification-shared Instructions
...
This is the local policy adapter for `@app/backend-feature-notification-shared` at `libs/backend/feature/notification/shared/lib`.
