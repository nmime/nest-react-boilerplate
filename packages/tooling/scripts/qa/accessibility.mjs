...
if (!urls.length) {
  writeJson(out, { status: "failed", error: "No accessibility targets. Build apps/storybook or set A11Y_URLS." });
  console.error("No accessibility targets. Build apps/storybook or set A11Y_URLS.");
  process.exit(1);
}
