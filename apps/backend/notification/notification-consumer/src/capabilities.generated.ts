...
@Global()
@Module({ imports: [AuthPostgresModule, FeatureFlagsPostgresModule, NotificationMainModule.forRoot({ enableConsumer: true, exposeHttp: false }), NotificationPostgresModule, PostgresMainModule.forRoot(), S3Module.forRoot()], exports: [AuthPostgresModule, FeatureFlagsPostgresModule, NotificationMainModule, NotificationPostgresModule, PostgresMainModule, S3Module] })
