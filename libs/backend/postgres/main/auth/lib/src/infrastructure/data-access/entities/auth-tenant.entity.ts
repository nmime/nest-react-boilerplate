...
export type AuthTenantInvitationStatus = 'pending' | 'accepted' | 'revoked' | 'expired';
...
export const AuthTenantMembershipEntitySchema = new EntitySchema<AuthTenantMembershipEntity>({
...
export const AuthTenantInvitationEntitySchema = new EntitySchema<AuthTenantInvitationEntity>({
