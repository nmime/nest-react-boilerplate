...
export default defineConfig({
  cacheDir: '../../../../node_modules/.vitest/apps/backend/user/user-app-api-e2e',
  resolve: {
    tsconfigPaths: true,
    alias: {
  ...
  test: {
    ...
    coverage: {
      enabled: true,
      provider: 'v8',
      reportsDirectory: workspaceCoverageDirectory('coverage/e2e/apps/backend/user/user-app-api'),
