...
import type { AuthPreferencesPayload, UserPreferencePatch } from './session-preferences-model';
...
export async function updateUserPreferences(
  ...
  return throwOnOpenApiErrorData(authClient.authControllerUpdatePreferences(nextPreferences, requestOptions));
}
