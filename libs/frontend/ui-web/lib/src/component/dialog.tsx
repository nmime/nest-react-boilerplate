...
export const DialogOverlay = forwardRef<ComponentRef<typeof DialogPrimitive.Overlay>, DialogOverlayProps>(
  ({ className, ...props }, ref) => (
...
export const DialogContent = forwardRef<ComponentRef<typeof DialogPrimitive.Content>, DialogContentProps>(
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      <DialogOverlay />
      <DialogPrimitive.Content className={cn('xr-dialog', className)} data-slot="dialog-content" ref={ref} {...props}>
        {children}
...
export const DialogHeader = ({ className, ...props }: Readonly<DialogHeaderProps>) => (
  <div className={cn('xr-dialog__header', className)} data-slot="dialog-header" {...props} />
);

export type DialogFooterProps = HTMLAttributes<HTMLDivElement>;

export const DialogFooter = ({ className, ...props }: Readonly<DialogFooterProps>) => (
  <div className={cn('xr-dialog__footer', className)} data-slot="dialog-footer" {...props} />
);
...
export const AlertDialogTitle = forwardRef<ComponentRef<typeof AlertDialogPrimitive.Title>, AlertDialogTitleProps>(
  ({ className, ...props }, ref) => (
