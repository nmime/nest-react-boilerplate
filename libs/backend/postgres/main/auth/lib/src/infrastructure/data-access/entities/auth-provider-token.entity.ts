...
export function toRedactedAuthProviderTokenView(entity: AuthProviderTokenEntity): RedactedAuthProviderTokenView {
  return {
    id: entity.id,
...
export const AuthProviderTokenEntitySchema = new EntitySchema<AuthProviderTokenEntity>({
