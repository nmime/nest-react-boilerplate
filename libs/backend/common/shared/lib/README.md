# @app/backend-common-shared

Path: `libs/backend/common/shared/lib`
Nx project: `@app/backend-common-shared`
...
```bash
pnpm exec nx run @app/backend-common-shared:build
pnpm exec nx run @app/backend-common-shared:test
```
