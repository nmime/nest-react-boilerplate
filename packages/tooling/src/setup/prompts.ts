...
export function buildConfig(
  ...
  return {
    ...
    tenant: {
      ...
      ...overrides.tenant,
      seed: {
        ...defaultTenantConfig.seed,
        ...overrides.tenant?.seed,
        admin: { ...defaultTenantSeedAdmin, ...overrides.tenant?.seed?.admin },
        users: overrides.tenant?.seed?.users ?? [...defaultTenantSeedUsers],
      },
    },
    options: {
