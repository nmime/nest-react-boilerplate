...
| Specification trace        | OpenSpec validity, complete project ownership, stable IDs, and evidence mappings              | `pnpm run spec:validate`          | Blocking                          | Writes the exact-SHA trace under `test-results/spec-evidence`; see [Specification assurance](../specification-assurance.md). |
