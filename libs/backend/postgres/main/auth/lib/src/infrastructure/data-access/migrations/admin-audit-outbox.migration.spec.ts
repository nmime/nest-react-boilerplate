...
describe('admin audit/outbox migrations', () => {
  ...
  it('registers admin audit before outbox migrations', () => {
    expect(authMigrations).toContain(Migration20260605143000CreateAdminAuditLogs);
    expect(authMigrations).toContain(Migration20260606120000CreateTransactionalOutboxEvents);
