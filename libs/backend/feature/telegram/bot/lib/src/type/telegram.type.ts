...
export interface TelegramBotAuthPort {
  consumeLinkPayload(payload: string, identity: TelegramBotIdentity): Promise<TelegramLinkPayload | null>;
...
export type TelegramBotContext = TelegramBaseContext & HydrateFlavor<TelegramBaseContext>;
