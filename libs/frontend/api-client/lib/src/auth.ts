...
const authDiscordAuthorizationRequestPath =
...
export type DiscordCallbackQuery = NonNullable<
  paths[typeof authDiscordCallbackPath]["get"]["parameters"]["query"]
>;
...
export type AuthControllerRefreshResponse = OpenApiData<
  typeof authControllerRefresh
>;
export type AuthControllerRefreshData =
  EnvelopeData<AuthControllerRefreshResponse>;
export type AuthControllerRefreshError = OpenApiError<
  typeof authControllerRefresh
>;
...
export const getAuthControllerProviderIdentitiesQueryKey = () =>
  ["get", authProviderIdentitiesPath] as const;
...
export const getAuthControllerUnlinkProviderIdentityMutationKey = () =>
  ["delete", authProviderIdentityPath] as const;
export const getAuthControllerCreateLinkTokenMutationKey = () =>
  ["post", authLinkTokensPath] as const;
