...
import { CurrentUser, Public, RequirePermissions, RequireRoles } from './access-control.decorators';
...
class DecoratedController {
  ...
  currentUser(@CurrentUser() currentPrincipal: AuthenticatedPrincipal | undefined) {
    return { principal: currentPrincipal };
  }

  @Get('decorated-auth')
  currentAuth(@CurrentUser() currentPrincipal: AuthenticatedPrincipal | undefined) {
    return { principal: currentPrincipal };
  }
}
