# @app/backend-feature-admin-shared Instructions
...
This is the local policy adapter for `@app/backend-feature-admin-shared` at `libs/backend/feature/admin/shared/lib`.
