...
export const landingFrontendCatalogFileNames = catalogFileNames;

export const landingFrontendTranslations: FrontendTranslations = buildLocaleTranslations(localeCatalogFiles);
