...
describe('process runtime', () => {
  it('reuses the active Corepack package-manager module without a shell', () => {
    assert.deepEqual(
  ...
  it('fails clearly on Windows when tooling was not launched through pnpm', () => {
    assert.throws(
  ...
  it('terminates a child process at its configured deadline', () => {
