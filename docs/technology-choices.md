...
Nx 23 provides project graph awareness, cached targets, module-boundary enforcement, and consistent commands across apps and libraries. pnpm 11.10.0 is pinned for deterministic workspace installs on the Node.js `>=24 <25` engine range.
