...
Please report suspected vulnerabilities privately to the repository owner or security contact configured for your launched project. Until your project replaces it, report via [GitHub Security Advisories](https://github.com/nmime/nest-react-boilerplate/security/advisories/new). Do not open public issues for exploitable findings.
