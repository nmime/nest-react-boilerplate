...
export const AuditPage = ({ requestOptions }: Readonly<{ requestOptions?: ApiClientRequestOptions }>) => {
  const { t } = useI18n();
  ...
  const audit = useQuery({
    queryKey: [...adminApi.getAdminUsersControllerListAuditQueryKey(params), requestOptions] as const,
    queryFn: () => throwOnOpenApiErrorData(adminApi.adminUsersControllerListAudit(params, requestOptions)),
    retry: false,
  });
