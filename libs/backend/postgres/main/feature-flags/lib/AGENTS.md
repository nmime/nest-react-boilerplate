# @app/backend-postgres-main-feature-flags Instructions
...
This is the local policy adapter for `@app/backend-postgres-main-feature-flags` at `libs/backend/postgres/main/feature-flags/lib`.
