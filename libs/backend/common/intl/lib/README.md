# @app/backend-common-intl

Path: `libs/backend/common/intl/lib`
Nx project: `@app/backend-common-intl`
...
```bash
pnpm exec nx run @app/backend-common-intl:build
pnpm exec nx run @app/backend-common-intl:test
```
