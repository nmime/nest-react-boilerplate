# @app/backend-feature-notification-main Instructions
...
This is the local policy adapter for `@app/backend-feature-notification-main` at `libs/backend/feature/notification/main/lib`.
