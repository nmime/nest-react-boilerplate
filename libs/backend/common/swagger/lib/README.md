...
Path: `libs/backend/common/swagger/lib`
Nx project: `@app/backend-common-swagger`
...
```bash
pnpm exec nx run @app/backend-common-swagger:build
pnpm exec nx run @app/backend-common-swagger:test
```
