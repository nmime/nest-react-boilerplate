# @app/backend-feature-telegram-bot Instructions
...
This is the local policy adapter for `@app/backend-feature-telegram-bot` at `libs/backend/feature/telegram/bot/lib`.
