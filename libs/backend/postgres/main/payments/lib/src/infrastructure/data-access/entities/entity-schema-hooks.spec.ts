...
import { PaymentEntitySchema, PaymentProviderEntitySchema, PaymentProviderHealthEntitySchema } from './index';
...
describe('payments entity schema creation hooks', () => {
  it('stamps creation timestamps for mutable rows', () => {
    for (const schema of [PaymentEntitySchema, PaymentProviderEntitySchema, PaymentProviderHealthEntitySchema]) {
      schema.init();
    }
