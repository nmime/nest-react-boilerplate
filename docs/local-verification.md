...
pnpm exec vitest run libs/backend/feature/auth/main/lib/src/infrastructure/auth-token-store.spec.ts libs/backend/postgres/main/auth/lib/src/infrastructure/data-access/repositories/auth-token.repository.spec.ts
```
