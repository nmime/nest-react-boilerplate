...
export const translations = {
  en: {
    ...
    "admin.action.users": "Users",
    "admin.action.roles": "Roles",
    "admin.action.audit": "Audit",
    "admin.status.active": "Active",
    "admin.status.disabled": "Disabled",
    "admin.status.invited": "Invited",
    "admin.state.loading": "Loading",
    "admin.health.eyebrow": "Health",
    "admin.health.live": "Live",
    "admin.health.ready": "Ready",
    "admin.health.unavailable": "Unavailable",
    "admin.dashboard.summary.totalUsers": "Total users",
    "admin.dashboard.summary.totalUsersDetail": "From /admin/dashboard/summary",
    "admin.dashboard.summary.activeUsers": "Active users",
    "admin.dashboard.summary.activeUsersDetail": "Current active users",
    "admin.dashboard.summary.disabledUsers": "Disabled users",
    "admin.dashboard.summary.disabledUsersDetail": "Current disabled users",
    "admin.dashboard.summary.recentAudit": "Recent audit",
    "admin.dashboard.summary.recentAuditDetail": "Recent audit events",
    "admin.dashboard.loadingSummary": "Loading admin dashboard summary",
    "admin.dashboard.error.summaryRequestFailed":
      "Dashboard summary request failed",
    "admin.users.eyebrow": "Current user entities",
    "admin.users.title": "Users",
    "admin.users.searchLabel": "Search users",
    "admin.users.searchPlaceholder": "Search email or display name",
    ...
    "admin.users.filter.permission": "Permission",
    "admin.users.filter.allPermissions": "All permissions",
    "admin.users.loading": "Loading users",
    "admin.users.emptyEyebrow": "No users found",
    "admin.users.emptyTitle":
      "No client-side fake data is shown; adjust filters or wait for real /admin/users data.",
    ...
    "admin.users.row.open": "Open user {{email}}",
    "admin.users.action.changeStatus": "Change status",
    "admin.users.action.editAccessPolicy": "Edit access policy",
    "admin.users.detail.title": "User detail",
    "admin.users.detail.loading": "Loading user detail",
    "admin.users.detail.emptyEyebrow": "No user selected",
    "admin.users.detail.emptyTitle":
      "Select a real user from /admin/users to inspect details.",
    ...
    "admin.users.error.requestFailed": "Users request failed",
    "admin.users.error.detailRequestFailed": "User detail request failed",
    "admin.users.error.statusUpdateFailed": "Status update failed",
    "admin.users.error.accessPolicyUpdateFailed": "Access policy update failed",
    "admin.users.error.statusReasonRequired":
      "Enter a reason before changing status.",
    "admin.users.error.policyReasonRequired":
      "Enter a reason before changing access policy.",
    "admin.users.error.roleRequired":
      "Select at least one role before updating access policy.",
    "admin.users.statusDialog.eyebrow": "Confirm status update",
    "admin.users.statusDialog.title": "Update status",
    "admin.users.statusDialog.description":
      "Update {{email}} to {{status}}. Backend remains authoritative.",
    "admin.users.policyDialog.eyebrow": "Confirm access policy update",
    "admin.users.policyDialog.title": "Update access policy",
    ...
    "admin.roles.loading": "Loading roles matrix",
    ...
    "admin.roles.assignmentLabel": "{{permission}} assigned to {{role}}",
    "admin.audit.eyebrow": "Real admin audit events",
    ...
    "admin.audit.column.created": "Created",
    "admin.tenants.eyebrow": "Roadmap",
    "admin.tenants.title": "Tenants, memberships, and invitations",
    "admin.tenants.cardTitle": "Tenant administration roadmap",
    "admin.tenants.description":
      "No tenant, membership, or invitation table is rendered because this admin frontend only uses current real API entities.",
    "admin.permission.usersMissing": "Missing admin users permission.",
    "admin.permission.rolesMissing": "Missing admin roles permission.",
    "admin.permission.auditMissing": "Missing admin audit permission.",
  ...
  ru: {
    ...
    "admin.action.users": "Пользователи",
    "admin.action.roles": "Роли",
    "admin.action.audit": "Аудит",
    "admin.status.active": "Активен",
    "admin.status.disabled": "Отключен",
    "admin.status.invited": "Приглашен",
    "admin.state.loading": "Загрузка",
    "admin.health.eyebrow": "Состояние",
    "admin.health.live": "Live",
    "admin.health.ready": "Ready",
    "admin.health.unavailable": "Недоступно",
    "admin.dashboard.summary.totalUsers": "Всего пользователей",
    "admin.dashboard.summary.totalUsersDetail": "Из /admin/dashboard/summary",
    "admin.dashboard.summary.activeUsers": "Активные пользователи",
    "admin.dashboard.summary.activeUsersDetail":
      "Текущие активные пользователи",
    "admin.dashboard.summary.disabledUsers": "Отключенные пользователи",
    "admin.dashboard.summary.disabledUsersDetail":
      "Текущие отключенные пользователи",
    "admin.dashboard.summary.recentAudit": "Последний аудит",
    "admin.dashboard.summary.recentAuditDetail": "Последние события аудита",
    "admin.dashboard.loadingSummary": "Загрузка сводки панели администратора",
    "admin.dashboard.error.summaryRequestFailed":
      "Не удалось запросить сводку панели",
    "admin.users.eyebrow": "Текущие сущности пользователей",
    "admin.users.title": "Пользователи",
    "admin.users.searchLabel": "Поиск пользователей",
    "admin.users.searchPlaceholder": "Поиск по email или отображаемому имени",
    "admin.users.filter.status": "Статус",
    "admin.users.filter.allStatuses": "Все статусы",
    "admin.users.filter.role": "Роль",
    "admin.users.filter.allRoles": "Все роли",
    "admin.users.filter.permission": "Разрешение",
    "admin.users.filter.allPermissions": "Все разрешения",
    "admin.users.loading": "Загрузка пользователей",
    "admin.users.emptyEyebrow": "Пользователи не найдены",
    "admin.users.emptyTitle":
      "Клиентские фиктивные данные не показываются; измените фильтры или дождитесь реальных данных /admin/users.",
    "admin.users.column.email": "Email",
    "admin.users.column.status": "Статус",
    "admin.users.column.roles": "Роли",
    "admin.users.column.actions": "Действия",
    "admin.users.row.open": "Открыть пользователя {{email}}",
    "admin.users.action.changeStatus": "Изменить статус",
    "admin.users.action.editAccessPolicy": "Изменить политику доступа",
    "admin.users.detail.title": "Детали пользователя",
    "admin.users.detail.loading": "Загрузка деталей пользователя",
    "admin.users.detail.emptyEyebrow": "Пользователь не выбран",
    "admin.users.detail.emptyTitle":
      "Выберите реального пользователя из /admin/users для просмотра деталей.",
    "admin.users.detail.lastLogin": "Последний вход",
    "admin.users.notice.statusUpdateRequested":
      "Запрошено обновление статуса; текущие сущности будут перезагружены.",
    "admin.users.notice.accessPolicyUpdateRequested":
      "Запрошено обновление политики доступа; текущие сущности будут перезагружены.",
    "admin.users.error.requestFailed": "Не удалось запросить пользователей",
    "admin.users.error.detailRequestFailed":
      "Не удалось запросить детали пользователя",
    "admin.users.error.statusUpdateFailed": "Не удалось обновить статус",
    "admin.users.error.accessPolicyUpdateFailed":
      "Не удалось обновить политику доступа",
    "admin.users.error.statusReasonRequired":
      "Укажите причину перед изменением статуса.",
    "admin.users.error.policyReasonRequired":
      "Укажите причину перед изменением политики доступа.",
    "admin.users.error.roleRequired":
      "Выберите хотя бы одну роль перед обновлением политики доступа.",
    "admin.users.statusDialog.eyebrow": "Подтвердите обновление статуса",
    "admin.users.statusDialog.title": "Обновить статус",
    "admin.users.statusDialog.description":
      "Обновить {{email}} до {{status}}. Бэкенд остается источником истины.",
    "admin.users.policyDialog.eyebrow":
      "Подтвердите обновление политики доступа",
    "admin.users.policyDialog.title": "Обновить политику доступа",
    "admin.users.policyDialog.description":
    ...
    "admin.roles.title": "Роли и разрешения",
    "admin.roles.loading": "Загрузка матрицы ролей",
    ...
    "admin.roles.assignmentLabel": "{{permission}} назначено роли {{role}}",
    "admin.audit.eyebrow": "Реальные события аудита администратора",
    ...
    "admin.audit.column.target": "Цель",
    "admin.audit.column.created": "Создано",
    "admin.tenants.eyebrow": "План",
    "admin.tenants.title": "Тенанты, участники и приглашения",
    "admin.tenants.cardTitle": "План администрирования тенантов",
    "admin.tenants.description":
      "Таблица тенантов, участников или приглашений не отображается, потому что эта панель администратора использует только текущие реальные API-сущности.",
    "admin.permission.usersMissing":
      "Отсутствует разрешение на пользователей администратора.",
    "admin.permission.rolesMissing":
      "Отсутствует разрешение на роли администратора.",
    "admin.permission.auditMissing":
      "Отсутствует разрешение на аудит администратора.",
