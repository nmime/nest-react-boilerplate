...
export class Migration20260828110000CreateApiResponseStudio extends Migration {
  override up(): void {
    ...
    this.addSql(
      `create index "ix__api_response_studio_sources__tenant_enabled" on "api_response_studio_sources" ("tenant_id","enabled");`,
    );
    ...
    this.addSql(
      `create index "ix__api_response_studio_responses__tenant_source_path" on "api_response_studio_responses" ("tenant_id","source_id","path"); create index "ix__api_response_studio_responses__tenant_change" on "api_response_studio_responses" ("tenant_id","change_state","change_dismissed"); create index "ix__api_response_studio_responses__tenant_deleted" on "api_response_studio_responses" ("tenant_id","deleted");`,
    );
    ...
    this.addSql(
      `create index "ix__api_response_studio_history__tenant_created" on "api_response_studio_history" ("tenant_id","created_at" desc); create index "ix__api_response_studio_history__tenant_source_created" on "api_response_studio_history" ("tenant_id","source_id","created_at" desc); create index "ix__api_response_studio_history__tenant_response_created" on "api_response_studio_history" ("tenant_id","response_id","created_at" desc);`,
    );
  }
