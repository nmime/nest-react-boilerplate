...
export const AdminAuditActions = [
  ...
  'admin.api_response_studio.source.create',
  'admin.api_response_studio.source.update',
  'admin.api_response_studio.sync',
  'admin.api_response_studio.response.update',
  'admin.api_response_studio.response.reset',
  'admin.api_response_studio.response.bulk_update',
  'admin.api_response_studio.change.dismiss',
