...
export const adminFrontendCatalogFileNames = catalogFileNames;

export const adminFrontendTranslations: FrontendTranslations = buildLocaleTranslations(localeCatalogFiles);
