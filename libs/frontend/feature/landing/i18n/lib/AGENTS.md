# @app/frontend-feature-landing-i18n Instructions
...
This is the local policy adapter for `@app/frontend-feature-landing-i18n` at `libs/frontend/feature/landing/i18n/lib`.
