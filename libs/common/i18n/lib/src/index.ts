...
export const translations = {
  ...
  ru: {
    ...
    "landing.title": "Запустите готовую full-stack основу продукта на Nest и React.",
    "landing.description":
    ...
    "admin.permission.dashboardMissing": "Отсутствует разрешение на панель администратора.",
    "admin.permission.profileMissing": "Отсутствует разрешение на профиль администратора.",
    ...
    "user.title": "Войдите, зарегистрируйтесь и загрузите свой защищенный профиль.",
    "user.description":
    ...
    "user.state.missingToken": "Предоставьте токен или войдите/зарегистрируйтесь.",
    ...
    "errors.auth.expired": "Время действия JWT истекло.",
    ...
    "errors.auth.principalMissing": "Отсутствуют данные аутентификации пользователя.",
    ...
    "validation.constraints.isEmail": "Поле {{property}} должно быть действительным email-адресом",
