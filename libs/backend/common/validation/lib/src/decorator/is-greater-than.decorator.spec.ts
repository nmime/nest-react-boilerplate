...
async function firstConstraint(instance: Bounds | BoundsWithMessage): Promise<Record<string, string> | undefined> {
...
describe('IsGreaterThan', () => {
  ...
  it('fails when the value equals the related number', async () => {
    ...
    await expect(firstConstraint(bounds)).resolves.toHaveProperty('isGreaterThan');
  });
